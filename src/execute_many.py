...
configuration, data_path, results_path, sub_folder =\
        10, 'C:\\Users\\ChristinaZ\\Desktop\\All_Data', '..\\results', 'expert'

run_cmd = "python \"{}\" \"{}\" \"{}\" \"{}\" \"{}\"".format(clf_file, configuration, data_path, results_path, sub_folder)
os.system(run_cmd)

configuration, data_path, results_path, sub_folder =\
        11, 'C:\\Users\\ChristinaZ\\Desktop\\All_Data', '..\\results', 'expert'

run_cmd = "python \"{}\" \"{}\" \"{}\" \"{}\" \"{}\"".format(clf_file, configuration, data_path, results_path, sub_folder)
os.system(run_cmd)

configuration, data_path, results_path, sub_folder =\
        12, 'C:\\Users\\ChristinaZ\\Desktop\\All_Data', '..\\results', 'expert'
