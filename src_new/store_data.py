...
class Decease:
    ...
    def get_body_form(self):
        ...
        for field in fields:
            values = fields_dict[field]['properties']['values']
            possible_values = None
            if 'possible_values' in fields_dict[field]['properties'].keys():
                possible_values = fields_dict[field]['properties']['possible_values']
